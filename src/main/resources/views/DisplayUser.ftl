  ...
  <body>
	...
	<form class="form-horizontal" action="/update" method="POST">
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">User ID*</label>
			<div class="col-sm-8">
			  <input type="number" class="form-control" id="inputEmail3" value=${id} name="user_id" >
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">First Name*</label>
			<div class="col-sm-8">
			  <input type="text" class="form-control" id="inputEmail3" placeholder=${firstName} name="first_name" pattern="[A-Za-z]+" >
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">Middle Name</label>
			<div class="col-sm-8">
			  <input type="text" class="form-control" id="inputEmail3" name="middle_name" pattern="[A-Za-z]*"  placeholder=${middleName}>
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">Last Name*</label>
			<div class="col-sm-8">
			  <input type="text" class="form-control" id="inputEmail3" placeholder=${lastName} name="last_name" pattern="[A-Za-z]+" >
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">Age*</label>
			<div class="col-sm-8">
			  <input type="number" class="form-control" id="inputEmail3" placeholder=${age} name="age" min="1" pattern="[0-9]{2}" >
			  <span class="help-block">Enter positive number.</span>
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">Gender* </label>
			<div class="col-sm-8">
			  <input type="text" class="form-control" id="inputEmail3" placeholder=${gender} name="gender" pattern="[M,F]{1}" >
			  <span class="help-block">Enter F/M.</span>
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">Phone*</label>
			<div class="col-sm-8">
				<input type="text" class="form-control" id="inputEmail3" placeholder=${phone} name="phone" pattern="[0-9]{10}" >
				<span class="help-block">Enter a <i>ten</i> digit phone number.</span>
			</div>
		</div>
		<div class="form-group">
			<label for="inputEmail3" class="col-sm-3 control-label">Zip</label>
			<div class="col-sm-8">
			  <input type="text" class="form-control" id="inputEmail3"  name="zip" placeholder=${zip}>
			</div>
		</div>
		<button type="submit" class="btn btn-primary col-md-2 col-md-offset-5">Submit</button><br><br>
	</form>
